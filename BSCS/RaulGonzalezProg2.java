...

{
    ...
    static int m = RaulGonzalezProg2.n; //
...
public class RaulGonzalezProg2

{
    ...
    
    {
        ...
        p2.start();
        p3.start();
        p2.join(); //Join Statement no permite continuar hasta que estos hagan join
        p3.join(); //Join Statement no permite continuar hasta que estos hagan join
        p4.start();
        p5.start();
        p1.join(); //Join Statement no permite continuar hasta que estos hagan join
        p4.join(); //Join Statement no permite continuar hasta que estos hagan join
        p6.start();
        p7.start();
        p6.join(); //Join Statement no permite continuar hasta que estos hagan join
        p7.join(); //Join Statement no permite continuar hasta que estos hagan join
        p8.start();
        p9.start();
    }
}